...
if __name__ == '__main__':
    ...
    '''
    config_file = "../ubisoft-laforge-ZeroEGGS/configs/data_pipeline_conf_v1.json"
    ...
    #
    # # processed_data_path = "../ubisoft-laforge-ZeroEGGS/Data/processed_v1/processed_data.npz"
